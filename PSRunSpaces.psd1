...
CompanyName = 'Srinath Sadda'

# Copyright statement for this module
Copyright = 'Copyright © 2015 Srinath Sadda. All rights reserved'

# Description of the functionality provided by this module
Description = 'Holds functions to invoke runspaces with multi-threading'
